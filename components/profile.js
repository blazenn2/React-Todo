...
const profile = () => {
    ...
    return (
        <>
            ...
            <div className={`${showSetting ? "" : "hidden"} transition ease-in-out delay-150 absolute right-5 top-14 md:top-16 lg:top-20 w-60 h-40 bg-[#fff] z-50 rounded-xl shadow-xl`}>
